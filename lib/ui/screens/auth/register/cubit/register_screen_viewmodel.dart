...
class RegisterScreenViewModel extends Cubit<RegisterScreenStates> {
  ...
  var userNameController = TextEditingController(text: 'mohamed');
  var userPhoneNoController = TextEditingController(text: '01234567890');
  var userEmailController = TextEditingController(text: 'moh.abg@gmail.com');
